...
import com.oceanmtech.chattingapp.databinding.ActivitySetupProfileBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSetupProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Code in this listener is to save the user profile data in Firebase Realtime Database. Image will be saved in
                // Firebase Storage.
                ...
                if(selectedImage != null) {
                    ...
                    // if image is not selected then following code will execute.
                    String uid = auth.getUid();
                    String phone = auth.getCurrentUser().getPhoneNumber();
