...
import com.oceanmtech.chattingapp.Activities.MainActivity;
...
import com.oceanmtech.chattingapp.databinding.RowStatusBinding;
...
public class TopStatusAdapter extends RecyclerView.Adapter<TopStatusAdapter.TopStatusViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TopStatusViewHolder holder, int position) {
        ...
        Glide.with(context).load(lastStatus.getImageUrl()).into(holder.binding.ivLastStatus);
